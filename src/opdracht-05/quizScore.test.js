...
describe('Quiz Score', () => {
  ...
  test('calculatePercentage berekent juiste percentage', () => {
    ...
    const answers = [
      { question: 1, isCorrect: true, points: 20 },
      { question: 2, isCorrect: true, points: 20 },
      { question: 3, isCorrect: false, points: 0 },
      { question: 4, isCorrect: true, points: 20 },
      { question: 5, isCorrect: true, points: 20 }
    ];
    expect(calculatePercentage(answers)).toBe(80);
  });
  ...
  test('isPassed geeft true bij 60% of hoger', () => {
    ...
    expect(isPassed(answers)).toBe(true);
  });
  ...
  test('getGrade geeft Excellent bij 90%+', () => {
    ...
    const answers = [
      { question: 1, isCorrect: true, points: 20 },
      { question: 2, isCorrect: true, points: 20 },
      { question: 3, isCorrect: true, points: 20 },
      { question: 4, isCorrect: true, points: 20 },
      { question: 5, isCorrect: true, points: 10 }
    ];
  ...
  test('getGrade geeft Goed bij 75-89%', () => {
    ...
    const answers = [
      ...
      { question: 3, isCorrect: true, points: 20 },
      { question: 4, isCorrect: true, points: 20 },
      { question: 5, isCorrect: false, points: 10 }
    ];
  ...
  test('countWrongAnswers telt foute antwoorden', () => {
    ...
    expect(countWrongAnswers(answers)).toBe(1)
  });
